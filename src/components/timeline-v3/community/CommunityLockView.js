...
/**
 * CommunityLockView
 * Immersive lock/redirect view shown when user lacks membership or role for a community timeline page.
 * Follows the new October 2025 redirect page standard with gradient backgrounds and glassmorphism.
 * Props:
